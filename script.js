...
function renderPokemon() {
  ...
  for (let i = 0; i < allPokemon.length; i++) {
    ...
    PokemonImg = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${
      i + 1
    }.png`;
    renderTypeColor(PokemonType);
    pokedex.innerHTML += renderPokedex(
      i,
      PokemonName,
      PokemonOrder,
      PokemonImg,
...
//render the Pokédex with all the Information
...
function renderStatus(i) {
  ...
  document.getElementById("hp").innerHTML =
    allPokemon[i]["stats"]["0"]["base_stat"] + "HP";
